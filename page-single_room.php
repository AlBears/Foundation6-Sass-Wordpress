         ...
         <div class="medium-up-4 small-up-2">
           ...
           foreach ($ids as $image_id) :
             ...
             <div class="column">
                 ...
                 <!-- MODALS -->
                 <div class="reveal tiny" id="galleryModal<?php echo $i; ?>" data-close-on-click="true" data-reveal data-animation-in="scale-in-up" data-animation-out="scale-out-down">
